...
<head>
  ...
  <title>EditOutlet - Laundry</title>
...
<div class="card">
  <div class="card-body">
    ...
    <form class="row g-3" action="{{route('outlet_edit', $editoutlet->id_outlet)}}" method="post">
      @csrf
      <div class="col-12">
        <label for="alamat" class="form-label">Alamat</label>
        <input type="text" class="form-control" name="alamat" value="{{$editoutlet->alamat}}">
      </div>
      <div class="col-12">
        <label for="telp" class="form-label">Telp</label>
        <input type="integer" class="form-control" name="telp" value="{{$editoutlet->telp}}">
      </div>
