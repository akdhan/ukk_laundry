...
<head>
  ...
  <title>EditMember - Laundry</title>
    ...
    <form class="row g-3" action="{{route('member_edit', $editmember->id_member)}}" method="post">
      ...
      <div class="col-md-4">
                  ...
                  <select class="form-select" name="jenis_kelamin" >
                    <option value="Laki - laki" {{ old('jenis_kelamin',$editmember->jenis_kelamin) == 'Laki - laki' ? 'selected' : '' }}>Laki - laki</option>
                    <option value="Perempuan" {{ old('jenis_kelamin',$editmember->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                  </select>
                </div>
      <div class="col-12">
